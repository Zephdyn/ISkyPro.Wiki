...
Plugin SDK v2 is still a preview API in `2.0.0-preview.4`. It is suitable for early validation of stdio plugins and multilingual samples, but the final stable interface is not frozen.
