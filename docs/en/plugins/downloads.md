...
SDK archives are published with the GitHub Release for the same product version. The `2.0.0-preview.3` SDKs are still preview APIs and do not promise stable naming.
...
| SDK | File name |
| --- | --- |
| Legacy SDK | `ISkyPro-LegacySdk-2.0.0-preview.3.zip` |
