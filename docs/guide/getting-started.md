...
- Windows x64 / Windows ARM64，或 Linux x64 preview
...
Linux preview 包支持主程序、WebUI、QQBot 网关和 Plugin SDK v2 新插件。旧 DLL 插件、`isky.exe` x86 兼容宿主和 `message.dll` 兼容层仍只在 Windows 包中提供。
